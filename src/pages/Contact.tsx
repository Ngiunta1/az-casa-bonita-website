...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col overflow-y-scroll snap-y snap-mandatory h-auto">
      <section className="flex h-screen snap-start snap-always w-full items-center justify-center lg:p-20">
      ...
      <section
        className="flex h-screen snap-start snap-always w-full bg-cover bg-center"
        style={{
